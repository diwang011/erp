 ...
 * 
 * <p>ActiveIngredients complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ActiveIngredients"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="activeIngredient" type="{http://walmart.com/}activeIngredient" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ActiveIngredients", propOrder = {
    "activeIngredient"
})
public class ActiveIngredients {

    @XmlElement(required = true)
    protected List<ActiveIngredient> activeIngredient;
    ...
    public List<ActiveIngredient> getActiveIngredient() {
        if (activeIngredient == null) {
            activeIngredient = new ArrayList<ActiveIngredient>();
        }
