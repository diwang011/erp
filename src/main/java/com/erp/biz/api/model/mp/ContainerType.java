 ...
 * 
 * <p>ContainerType complex type的 Java 类。
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="containerTypeValue" maxOccurs="unbounded"&gt;
 *           &lt;simpleType&gt;
...
public class ContainerType {
    ...
    protected List<String> containerTypeValue;
     ...
     * This is why there is not a <CODE>set</CODE> method for the containerTypeValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContainerTypeValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getContainerTypeValue() {
        if (containerTypeValue == null) {
            containerTypeValue = new ArrayList<String>();
        }
