...
/**
 * Language(s) that a film has been dubbed with
 * 
 * <p>DubbedLanguages complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DubbedLanguages"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="dubbedLanguage" maxOccurs="unbounded"&gt;
 *           &lt;simpleType&gt;
...
@XmlType(name = "DubbedLanguages", propOrder = {
    "dubbedLanguage"
})
public class DubbedLanguages {
