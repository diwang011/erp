 ...
 * 
 * <p>FocusType complex type的 Java 类。
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="focusTypeValue" maxOccurs="unbounded"&gt;
 *           &lt;simpleType&gt;
...
public class FocusType {
    ...
    protected List<String> focusTypeValue;

    /**
     * Gets the value of the focusTypeValue property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the focusTypeValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFocusTypeValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getFocusTypeValue() {
        if (focusTypeValue == null) {
            focusTypeValue = new ArrayList<String>();
        }
