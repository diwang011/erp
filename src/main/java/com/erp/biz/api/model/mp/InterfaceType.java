 ...
 * 
 * <p>InterfaceType complex type的 Java 类。
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="interfaceTypeValue" maxOccurs="unbounded"&gt;
 *           &lt;simpleType&gt;
...
public class InterfaceType {
    ...
    protected List<String> interfaceTypeValue;

    /**
     * Gets the value of the interfaceTypeValue property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the interfaceTypeValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterfaceTypeValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getInterfaceTypeValue() {
        if (interfaceTypeValue == null) {
            interfaceTypeValue = new ArrayList<String>();
        }
