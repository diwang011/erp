 ...
 * 
 * <p>Nutrients complex type的 Java 类。
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="nutrient" type="{http://walmart.com/}nutrient" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Nutrients {
    ...
    protected List<Nutrient> nutrient;
    ...
    public List<Nutrient> getNutrient() {
        if (nutrient == null) {
            nutrient = new ArrayList<Nutrient>();
        }
