...
/**
 * <p>GenericItemIngestionStatus complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="GenericItemIngestionStatus"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GenericItemIngestionStatus", propOrder = {
    "martId",
    "sku",
    "productId",
    "index",
...
public class GenericItemIngestionStatus {
    ...
    protected GenericItemIngestionStatus.IngestionErrors ingestionErrors;
     ...
     * @return
     *     possible object is
     *     {@link GenericItemIngestionStatus.IngestionErrors }
     *     
     */
    public GenericItemIngestionStatus.IngestionErrors getIngestionErrors() {
     ...
     *     
     */
    public void setIngestionErrors(GenericItemIngestionStatus.IngestionErrors value) {
