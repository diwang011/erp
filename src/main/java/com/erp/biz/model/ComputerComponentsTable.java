...
public class ComputerComponentsTable extends CommonTable
{
	...
	private List<String> processorType;
	public List<String> getProcessorType() {
		return processorType;
	}

	public void setProcessorType(List<String> processorType) {
	...
	private String maximumRamSupported_measure;
	public String getMaximumRamSupported_measure() {
		return maximumRamSupported_measure;
	}

	public void setMaximumRamSupported_measure(String maximumRamSupported_measure) {
		this.maximumRamSupported_measure = maximumRamSupported_measure;
	}

	private String ramMemory_unit;
	public String getRamMemory_unit() {
		return ramMemory_unit;
	}

	public void setRamMemory_unit(String ramMemory_unit) {
		this.ramMemory_unit = ramMemory_unit;
	}

	private List<String> cpuSocketType;
	public List<String> getCpuSocketType() {
		return cpuSocketType;
	}

	public void setCpuSocketType(List<String> cpuSocketType) {
	...
	private String hardDriveCapacity_unit;
	public String getHardDriveCapacity_unit() {
		return hardDriveCapacity_unit;
	}

	public void setHardDriveCapacity_unit(String hardDriveCapacity_unit) {
		this.hardDriveCapacity_unit = hardDriveCapacity_unit;
	}
	...
	private String hardDriveCapacity_measure;
	public String getHardDriveCapacity_measure() {
		return hardDriveCapacity_measure;
	}

	public void setHardDriveCapacity_measure(String hardDriveCapacity_measure) {
		this.hardDriveCapacity_measure = hardDriveCapacity_measure;
	}
	...
	private String processorSpeed_unit;
	public String getProcessorSpeed_unit() {
		return processorSpeed_unit;
	}

	public void setProcessorSpeed_unit(String processorSpeed_unit) {
		this.processorSpeed_unit = processorSpeed_unit;
	}
	...
	private String RAMSpeed_unit;
	public String getRAMSpeed_unit() {
		return RAMSpeed_unit;
	}

	public void setRAMSpeed_unit(String RAMSpeed_unit) {
		this.RAMSpeed_unit = RAMSpeed_unit;
	}

	private String maximumRamSupported_unit;
	public String getMaximumRamSupported_unit() {
		return maximumRamSupported_unit;
	}

	public void setMaximumRamSupported_unit(String maximumRamSupported_unit) {
		this.maximumRamSupported_unit = maximumRamSupported_unit;
	}

	private String ramMemory_measure;
	public String getRamMemory_measure() {
		return ramMemory_measure;
	}

	public void setRamMemory_measure(String ramMemory_measure) {
		this.ramMemory_measure = ramMemory_measure;
	}
	...
	private String RAMSpeed_measure;
	public String getRAMSpeed_measure() {
		return RAMSpeed_measure;
	}

	public void setRAMSpeed_measure(String RAMSpeed_measure) {
		this.RAMSpeed_measure = RAMSpeed_measure;
	}
	...
	private String processorSpeed_measure;
	public String getProcessorSpeed_measure() {
		return processorSpeed_measure;
	}

	public void setProcessorSpeed_measure(String processorSpeed_measure) {
		this.processorSpeed_measure = processorSpeed_measure;
	}
