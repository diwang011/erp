...
public class SoftwareTable extends CommonTable
{
	...
	public List<String> getSystemRequirements() {
		return systemRequirements;
	}

	public void setSystemRequirements(List<String> systemRequirements) {
	...
	private List<String> educationalFocus;
	public List<String> getEducationalFocus() {
		return educationalFocus;
	}

	public void setEducationalFocus(List<String> educationalFocus) {
	...
	private String digitalFileFormat;
	public String getDigitalFileFormat() {
		return digitalFileFormat;
	}

	public void setDigitalFileFormat(String digitalFileFormat) {
		this.digitalFileFormat = digitalFileFormat;
	}
	...
	private List<String> softwareCategory;
	public List<String> getSoftwareCategory() {
		return softwareCategory;
	}

	public void setSoftwareCategory(List<String> softwareCategory) {
